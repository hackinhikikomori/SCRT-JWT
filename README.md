# SCRT JWT
## Introduction
SCRT JWT is a tool to provision and verify JWTs implemented as a SCRT smart contract.
...
```
secretcli tx compute instantiate <code-id> '{"hours_until_token_expiration": <desired_token_ttl_in_hours>}' --from <your-wallet-name> -b block --label <your-label> -y
```
